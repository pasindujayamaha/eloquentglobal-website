...
// --------------------------------------------------
// Homepage commercial CTA integration
// --------------------------------------------------
...
if (currentFile === "services.html") {
    ...
    if (overviewGrid && !overviewGrid.querySelector('a[href="saas-development.html"]')) {
        const saasCard = document.createElement("a");
        saasCard.href = "saas-development.html";
        saasCard.className = "overview-card";
        saasCard.innerHTML = `
            <span class="overview-number">08</span>
            <div class="overview-icon">SaaS</div>
            <h3>SaaS Development</h3>
            <p>Custom subscription products, platforms and SaaS applications built for continued growth.</p>
            <span class="overview-arrow">→</span>
        `;
        overviewGrid.appendChild(saasCard);
    }
}
...
const seoPages = {
    ...
    "services.html": {
        ...
        description: "Explore Eloquent Global services including custom software, MVP development, SaaS development, web and mobile applications, AI automation, cloud infrastructure and digital marketing.",
    ...
    "saas-development.html": {
        ...
        description: "SaaS development services for startups and businesses in the USA, UK and Europe. Eloquent Global plans, designs, builds and scales custom SaaS products and platforms.",
        canonical: `${siteUrl}/saas-development.html`,
        type: "website",
        robots: "index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"
    },
    "portfolio.html": {
    ...
    "contact.html": {
        ...
        description: "Contact Eloquent Global to discuss custom software, MVP development, SaaS products, web or mobile products, AI solutions, digital marketing or an international business partnership.",
...
if (["mvp-development.html", "custom-software-development.html", "saas-development.html"].includes(currentFile)) {
    const serviceInfo = {
        "mvp-development.html": ["MVP Development Services for Startups", "Minimum Viable Product development"],
        "custom-software-development.html": ["Custom Software Development Services", "Custom software development"],
        "saas-development.html": ["SaaS Development Services", "Software as a Service development"]
    }[currentFile];
...
if (currentFile !== "index.html" && currentFile !== "requestquote.html") {
    const breadcrumbName = {
        ...
        "saas-development.html": "SaaS Development",
